...
var anotherConfigurationObject = builder.Configuration.GetSection("AnotherConfiguration");
builder.Services.Configure<AnotherConfigurationOptions>(anotherConfigurationObject);
