...
namespace NetCoreCourse.FirstExample.WebApp.Controllers
{
    ...
    public class GenericController : ControllerBase
    {
        ...
        public IActionResult GetSpecificationsFromClass()
        {
            ...
            var repositorio = new RepositorioBase<Prestamo>();
            var prestamo
                = new Prestamo {
                Id = 1,
                Descripcion = "Tablet"
            };
            var prestamo1 = repositorio.Add(prestamo);
            var prestamo2 = repositorio.ModifyDescription(prestamo, "Tablet Samsung");
            // Probar agregando la restriccion al generic.
            return Ok(new { intSpec, charSpec, transportSpec1, transportSpec2, prestamo1, prestamo2 });

        }
         
        [HttpGet("myList")]
        public IActionResult myGenericList()
        {
